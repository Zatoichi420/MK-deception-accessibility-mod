...
`sys.frozen`) or a plain `python deception_reader.py` checkout. No admin rights,
...
Called from deception_reader.py's --install / --uninstall / --status.
"""
...
LABEL = "com.orlando.mkdeception-menu-reader"   # macOS
SERVICE = "mkdeception-menu-reader"             # Linux unit / Windows task name
DESCRIPTION = "MK: Deception talking-menu daemon"
APP_DIR_NAME = "mkdeception-talking-menu"
