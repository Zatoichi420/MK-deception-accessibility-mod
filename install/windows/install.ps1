...
Copy-Item (Join-Path $RepoRoot "deception_reader.py"),(Join-Path $RepoRoot "ra_client.py"),`
          (Join-Path $RepoRoot "deception_addrs.py"),(Join-Path $RepoRoot "speak.py") $InstallDir -Force
...
sh.Run "cmd /c """"$py"" ""$InstallDir\deception_reader.py"" >> ""$Log"" 2>&1""", 0, False
